    ...
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" novalidate="novalidate">
        ...
        <?php if ($settings->get('client_id')): ?>
            <div class="error">
                ...
                <p>
                    <a href="https://social-login.nextendweb.com/documentation/providers/linkedin/#app-scoped-user-id" target="_blank"><?php _e('Find out why?', 'nextend-facebook-connect'); ?></a>
                </p>
            </div>
        <?php endif; ?>
