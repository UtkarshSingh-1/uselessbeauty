                ...
                <div class="product-search-modal__container-box">
                    ...
                    <div class="product-search-modal__search-actions">
                        <div class="product-search-modal__search-selected-products" style="display: none;">
                            ...
                            <div class="product-search-modal__selected-popover" style="display: none;">
                                <button
                                    type="button"
                                    class="product-search-modal__selected-trigger"
                                    aria-expanded="false"
                                    aria-haspopup="true"
                                ></button>
                                <div class="product-search-modal__selected-panel" aria-hidden="true">
                                    <div class="product-search-modal__selected-chips"></div>
                                </div>
                            </div>
                        </div>
                        <button
                        ...
                        <span
                            class="product-search-modal__confirm-button-wrap"
                            style="display: none;"
                            data-min-tooltip="<?php echo esc_attr( __( 'You need to add at least 2 products.', 'hostinger-affiliate-plugin' ) ); ?>">
                            <button
