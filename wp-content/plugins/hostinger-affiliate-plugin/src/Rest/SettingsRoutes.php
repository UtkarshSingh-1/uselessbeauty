...
class SettingsRoutes {
    ...
    public function __construct( PluginSettings $plugin_settings, PluginOptions $plugin_options, TransientRepository $transient_repository, CronjobSchedule $cronjob_schedule ) {
