...
class AdminTranslations {
    public static function get_values(): array {
        return array(
            'amazon_api_deprecated_notice'                           => __( 'Amazon Product Advertising API (PA-API) support has been removed. Your affiliate links continue to work. No action needed.', 'hostinger-affiliate-plugin' ),
            ...
            'tutorial_step5_title'                                   => __( 'Publish the post', 'hostinger-affiliate-plugin' ),
            ...
            'tutorial_step5_description'                             => __( 'That\'s it! Whenever a visitor buys a product through your link, you\'ll earn commission.', 'hostinger-affiliate-plugin' ),
            ...
            'tutorial_customize_block_title'                         => __( 'Customize the product block', 'hostinger-affiliate-plugin' ),
            'tutorial_customize_block_description'                   => __( 'With the product block selected, open the Block tab in the right sidebar to adjust the title, description, and buy button.', 'hostinger-affiliate-plugin' ),
            ...
            'settings_title'                                         => __( 'Amazon Settings', 'hostinger-affiliate-plugin' ),
            ...
            /* translators: %d: number of products (always 1 for this string). */
            'search_modal_selected_products_one'                     => __( '%d product selected', 'hostinger-affiliate-plugin' ),
            /* translators: %d: number of products (2 or more). */
            'search_modal_selected_products_other'                   => __( '%d products selected', 'hostinger-affiliate-plugin' ),
            'search_modal_remove_product_from_selection'             => __( 'Remove product from selection', 'hostinger-affiliate-plugin' ),
            'fatal_error_while_processing'                           => __( 'There was fatal server error while processing your request.', 'hostinger-affiliate-plugin' ),
            'tools_settings_mercado_livre_description'               => __( 'Manage your Mercado Livre general settings.', 'hostinger-affiliate-plugin' ),
            ...
            'table_collection_paste_shortcode_text'                  => __( 'You can add this table via the dedicated Block Editor (Gutenberg) block, or via the shortcode for any other editor, including Elementor.', 'hostinger-affiliate-plugin' ),
