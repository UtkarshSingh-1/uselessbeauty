        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"
                       id="tagline-tenant"><?php printf(__('The selected value will define the supported account types. %1$sLearn more.%2$s', 'nextend-facebook-connect'), '<a href="https://social-login.nextendweb.com/documentation/providers/microsoft/#audience" target="_blank">', '</a>'); ?></p>
                </td>
            </tr>
