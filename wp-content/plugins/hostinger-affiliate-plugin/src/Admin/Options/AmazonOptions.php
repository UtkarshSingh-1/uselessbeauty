...
class AmazonOptions {
    ...
    public function get_formats(): array {
        $default_language = ! empty( $this->locales[ $this->get_country() ]['language_of_preference']['default'] ) ? $this->locales[ $this->get_country() ]['language_of_preference']['default'] : '';

        return ! empty( $this->locales[ $this->get_country() ]['language_of_preference']['options'][ $default_language ] ) ? $this->locales[ $this->get_country() ]['language_of_preference']['options'][ $default_language ] : array();
    }
