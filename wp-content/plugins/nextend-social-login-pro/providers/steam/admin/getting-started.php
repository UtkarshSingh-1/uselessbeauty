...
<div class="nsl-admin-sub-content">
    ...
    <?php else: ?>
        <div class="nsl-admin-getting-started">
            ...
            <p><?php printf(__('<b>WARNING:</b> The %1$s API can not return any email address! %2$sLearn more%3$s.', 'nextend-facebook-connect'), 'Steam', '<a href="https://social-login.nextendweb.com/documentation/providers/steam/#empty-email" target="_blank">', '</a>'); ?></p>
